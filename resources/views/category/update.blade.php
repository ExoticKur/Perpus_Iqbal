...
<div class="modal fade" id="{{ Str::slug($category->name) }}" tabindex="-1" role="dialog" aria-labelledby="modalTitleId"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" role="document">
        <div class="modal-content text-start" style="background-color: #004953">
            <div class="modal-header">
                <h5 class="modal-title text-white" id="modalTitleId">Kategori Buku <span
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control text-black" style="background-color: white" name="name" id="name"
